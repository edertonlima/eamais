...
function change_post_label() {
    ...
    global $submenu;
    $menu[5][0] = 'Projetos';
    $submenu['edit.php'][5][0] = 'Todos os Projetos';
    $submenu['edit.php'][10][0] = 'Adicionar projetos';
    echo '';
}
function change_post_object() {
    ...
    $labels->singular_name = 'Projetos';
    $labels->add_new = 'Adicionar projetos';
    $labels->add_new_item = 'Adicionar projetos';
    $labels->edit_item = 'Editar projetos';
    $labels->new_item = 'Projetos';
    $labels->view_item = 'Ver projetos';
    $labels->search_items = 'Buscar projetos';
    $labels->not_found = 'Nenhum projetos encontrado';
    $labels->not_found_in_trash = 'Nenhum projetos encontrado na lixeira';
    $labels->all_items = 'Todos os projetos';
    $labels->menu_name = 'Projetos';
    $labels->name_admin_bar = 'Projetos';
}
